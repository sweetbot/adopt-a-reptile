...
fun YellowTheme(
    ...
    MainTheme(darkTheme, colors, content)
}
...
private val LightImages = Images(lockupLogo = R.drawable.ic_logo)

private val DarkImages = Images(lockupLogo = R.drawable.ic_logo)
